...
public class ArrayStack<E> implements Cloneable, Stack<E>{
    ...
    public static void main(String[] args) {
        ArrayStack<Integer> stackOldArray = new ArrayStack<>();
        ArrayStack<Integer> stackNewArray = new ArrayStack<>();
        stackOldArray.push(1);
        stackOldArray.push(2);
        stackOldArray.push(3);
        stackOldArray.push(4);
        System.out.println(stackOldArray);
        try {
            stackNewArray=stackOldArray.clone();
        }
        catch (Exception e){
            System.out.println(e.toString());
        }
        System.out.println(stackNewArray);         // contents: (7, 9, 6)  outputs 8
    }
